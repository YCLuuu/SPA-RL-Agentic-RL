...
class StepToolPPOTrain():
    ...
    def parse_args():
        ...
        parser.add_argument('--tokenizer_path', default=None, type=str, help='Path to the tokenizer (defaults to model_path)')
    ...
    def __init__(self, args):
        ...
        self.tokenizer_path = args.tokenizer_path or args.model_path
        self.seed = args.seed
